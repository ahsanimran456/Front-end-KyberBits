  ...
  return (
    ...
    >
      <motion.div className="text-center text-white max-w-auto w-full">
        {/* First Section */}
        <div className="max-w-screen-sm absolute right-[35%] top-[13%] ">
          <Image src={logo} alt="AI graphic" width={400} height={400} />
          {/* <motion.h1
        ...
        <div className="max-w-xl absolute bottom-[42%]">
           <motion.h1
            className="text-5xl text-left leading-tight font-sans font-bold text-transparent bg-clip-text"
            style={{
              backgroundImage:
                "linear-gradient(90deg, rgb(255, 140, 50), rgb(255, 200, 118) 15%, rgb(255, 255, 245) 40%, rgb(255, 255, 255) 50%, rgb(230, 255, 250) 70%, rgb(121, 255, 247) 90%)",
            }}
