    ...
    <section className="max-w-screen-xl mx-auto flex items-center w-full text-white mt-24">
      ...
      >
        ...
        <motion.p
          ...
          viewport={{ once: false }}
        >
          The integration of QUSD tokens with the dollar-backed Tether/Circle (USDT/USDC) introduces stability to the crypto environment, closely mirroring real-world currency values. This strategic connection between KyberBits and QUSD aims to enhance the utility of the TICS token, drawing users to its dependable and promising features.
        </motion.p>
