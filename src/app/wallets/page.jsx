            ...
            <section className="max-w-screen-xl mx-auto flex items-center w-full text-white ">
                ...
                >
                    ...
                    <motion.p
                        ...
                        viewport={{ once: false }}
                    >
                        Explore the KyberBits multi-chain crypto wallet, a non-custodial, open-source hub. Experience in-app feeless $TICS transfers, debit and virtual card options, smooth Apple Pay and Google Pay integration, a decentralized VPN (dVPN) service, and a gateway to a tokenized asset marketplace—all within a single application.
                    </motion.p>
                </motion.div>
            ...
            <section className="max-w-screen-xl mx-auto flex  mt-20 w-full text-white ">
                ...
                >
                    ...
                    <motion.p
                        ...
                        viewport={{ once: false }}
                    >
                        The KyberBits Wallet, an integral part of the KyberBits Network's ecosystem, is set to launch across multiple user-friendly platforms, including iOS, Android, and desktop interfaces. This wide-ranging accessibility ensures that users can manage their TICS tokens and other digital assets effortlessly, irrespective of their device preference.
                    </motion.p>
                    <motion.h1
                        className="text-lg leading-normal font-sans font-bold  text-white"
                        initial={{ opacity: 0, y: -50 }}
                    ...
                    <motion.p
                        ...
                        viewport={{ once: false }}
                    >
                        The KyberBits wallet introduces the capability for gasless transfers of TICS tokens within the ecosystem. This innovative feature is designed to enhance the user experience and encourage participation in the network. By eliminating transaction fees, it significantly increases the utility and appeal of the TICS token, streamlining interactions within the KyberBits ecosystem.
                    </motion.p>
                </motion.div>
